...
#define P_GAIN_DEFAULT 550.0
#define I_GAIN_DEFAULT 250.0
#define D_GAIN_DEFAULT 700.0
#define I_THRESH_DEFAULT 50
#define P_GAIN_SCALING 1000.0
#define I_GAIN_SCALING 5000.0
#define D_GAIN_SCALING 100.0
